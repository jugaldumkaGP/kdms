...
/**
 * Devotee ID scan image as base64 JSON. Dual-read: GCS path if set, else LONGBLOB.
 */
...
$result = PhotoStorage::readDevoteeIdImage($db, $devoteeKey);

if ($result === null) {
    echo json_encode([
        'status' => false,
        'message' => 'No ID image found for devotee',
